...
HOOK_EXPORT PROC WINAPI wglGetProcAddress(LPCSTR lpszProc)
{
  ...
  if (first_call)
  {
    ...
    //
		...
		reshade::hooks::queue(reinterpret_cast<reshade::hook::address>(trampoline("glDrawArraysIndirect")),                          reinterpret_cast<reshade::hook::address>(&glDrawArraysIndirect),                                         "glDrawArraysIndirect");
		reshade::hooks::queue(reinterpret_cast<reshade::hook::address>(trampoline("glDrawArraysInstanced")),                         reinterpret_cast<reshade::hook::address>(&glDrawArraysInstanced),                                        "glDrawArraysInstanced");
		reshade::hooks::queue(reinterpret_cast<reshade::hook::address>(trampoline("glDrawArraysInstancedEXT")),                      reinterpret_cast<reshade::hook::address>(&glDrawArraysInstancedEXT),                                     "glDrawArraysInstancedEXT");
		reshade::hooks::queue(reinterpret_cast<reshade::hook::address>(trampoline("glDrawArraysInstancedBaseInstance")),             reinterpret_cast<reshade::hook::address>(&glDrawArraysInstancedBaseInstance),                            "glDrawArraysInstancedBaseInstance");
		reshade::hooks::queue(reinterpret_cast<reshade::hook::address>(trampoline("glDrawElementsBaseVertex")),                      reinterpret_cast<reshade::hook::address>(&glDrawElementsBaseVertex),                                     "glDrawElementsBaseVertex");
		reshade::hooks::queue(reinterpret_cast<reshade::hook::address>(trampoline("glDrawElementsIndirect")),                        reinterpret_cast<reshade::hook::address>(&glDrawElementsIndirect),                                       "glDrawElementsIndirect");
		reshade::hooks::queue(reinterpret_cast<reshade::hook::address>(trampoline("glDrawElementsInstanced")),                       reinterpret_cast<reshade::hook::address>(&glDrawElementsInstanced),                                      "glDrawElementsInstanced");
		reshade::hooks::queue(reinterpret_cast<reshade::hook::address>(trampoline("glDrawElementsInstancedEXT")),                    reinterpret_cast<reshade::hook::address>(&glDrawElementsInstancedEXT),                                   "glDrawElementsInstancedEXT");
		reshade::hooks::queue(reinterpret_cast<reshade::hook::address>(trampoline("glDrawElementsInstancedBaseVertex")),             reinterpret_cast<reshade::hook::address>(&glDrawElementsInstancedBaseVertex),                            "glDrawElementsInstancedBaseVertex");
		reshade::hooks::queue(reinterpret_cast<reshade::hook::address>(trampoline("glDrawElementsInstancedBaseInstance")),           reinterpret_cast<reshade::hook::address>(&glDrawElementsInstancedBaseInstance),                          "glDrawElementsInstancedBaseInstance");
		reshade::hooks::queue(reinterpret_cast<reshade::hook::address>(trampoline("glDrawElementsInstancedBaseVertexBaseInstance")), reinterpret_cast<reshade::hook::address>(&glDrawElementsInstancedBaseVertexBaseInstance),                "glDrawElementsInstancedBaseVertexBaseInstance");
		reshade::hooks::queue(reinterpret_cast<reshade::hook::address>(trampoline("glDrawRangeElements")),                           reinterpret_cast<reshade::hook::address>(&glDrawRangeElements),                                         "glDrawRangeElements");
		reshade::hooks::queue(reinterpret_cast<reshade::hook::address>(trampoline("glDrawRangeElementsBaseVertex")),                 reinterpret_cast<reshade::hook::address>(&glDrawRangeElementsBaseVertex),                               "glDrawRangeElementsBaseVertex");
		reshade::hooks::queue(reinterpret_cast<reshade::hook::address>(trampoline("glFramebufferRenderbuffer")),                     reinterpret_cast<reshade::hook::address>(&glFramebufferRenderbuffer),                                   "glFramebufferRenderbuffer");
		reshade::hooks::queue(reinterpret_cast<reshade::hook::address>(trampoline("glFramebufferRenderbufferEXT")),                  reinterpret_cast<reshade::hook::address>(&glFramebufferRenderbufferEXT),                                "glFramebufferRenderbufferEXT");
		reshade::hooks::queue(reinterpret_cast<reshade::hook::address>(trampoline("glFramebufferTexture")),                          reinterpret_cast<reshade::hook::address>(&glFramebufferTexture),                                        "glFramebufferTexture");
		reshade::hooks::queue(reinterpret_cast<reshade::hook::address>(trampoline("glFramebufferTextureEXT")),                       reinterpret_cast<reshade::hook::address>(&glFramebufferTextureEXT),                                     "glFramebufferTextureEXT");
		reshade::hooks::queue(reinterpret_cast<reshade::hook::address>(trampoline("glFramebufferTexture1D")),                        reinterpret_cast<reshade::hook::address>(&glFramebufferTexture1D),                                      "glFramebufferTexture1D");
		reshade::hooks::queue(reinterpret_cast<reshade::hook::address>(trampoline("glFramebufferTexture1DEXT")),                     reinterpret_cast<reshade::hook::address>(&glFramebufferTexture1DEXT),                                   "glFramebufferTexture1DEXT");
		reshade::hooks::queue(reinterpret_cast<reshade::hook::address>(trampoline("glFramebufferTexture2D")),                        reinterpret_cast<reshade::hook::address>(&glFramebufferTexture2D),                                      "glFramebufferTexture2D");
		reshade::hooks::queue(reinterpret_cast<reshade::hook::address>(trampoline("glFramebufferTexture2DEXT")),                     reinterpret_cast<reshade::hook::address>(&glFramebufferTexture2DEXT),                                   "glFramebufferTexture2DEXT");
		reshade::hooks::queue(reinterpret_cast<reshade::hook::address>(trampoline("glFramebufferTexture3D")),                        reinterpret_cast<reshade::hook::address>(&glFramebufferTexture3D),                                      "glFramebufferTexture3D");
		reshade::hooks::queue(reinterpret_cast<reshade::hook::address>(trampoline("glFramebufferTexture3DEXT")),                     reinterpret_cast<reshade::hook::address>(&glFramebufferTexture3DEXT),                                   "glFramebufferTexture3DEXT");
		reshade::hooks::queue(reinterpret_cast<reshade::hook::address>(trampoline("glFramebufferTextureLayer")),                     reinterpret_cast<reshade::hook::address>(&glFramebufferTextureLayer),                                   "glFramebufferTextureLayer");
		reshade::hooks::queue(reinterpret_cast<reshade::hook::address>(trampoline("glFramebufferTextureLayerEXT")),                  reinterpret_cast<reshade::hook::address>(&glFramebufferTextureLayerEXT),                                "glFramebufferTextureLayerEXT");
		reshade::hooks::queue(reinterpret_cast<reshade::hook::address>(trampoline("glMultiDrawArrays")),                             reinterpret_cast<reshade::hook::address>(&glMultiDrawArrays),                                           "glMultiDrawArrays");
		reshade::hooks::queue(reinterpret_cast<reshade::hook::address>(trampoline("glMultiDrawArraysIndirect")),                     reinterpret_cast<reshade::hook::address>(&glMultiDrawArraysIndirect),                                   "glMultiDrawArraysIndirect");
		reshade::hooks::queue(reinterpret_cast<reshade::hook::address>(trampoline("glMultiDrawElements")),                           reinterpret_cast<reshade::hook::address>(&glMultiDrawElements),                                         "glMultiDrawElements");
		reshade::hooks::queue(reinterpret_cast<reshade::hook::address>(trampoline("glMultiDrawElementsBaseVertex")),                 reinterpret_cast<reshade::hook::address>(&glMultiDrawElementsBaseVertex),                               "glMultiDrawElementsBaseVertex");
		reshade::hooks::queue(reinterpret_cast<reshade::hook::address>(trampoline("glMultiDrawElementsIndirect")),                   reinterpret_cast<reshade::hook::address>(&glMultiDrawElementsIndirect),                                 "glMultiDrawElementsIndirect");
		reshade::hooks::queue(reinterpret_cast<reshade::hook::address>(trampoline("glTexImage3D")),                                  reinterpret_cast<reshade::hook::address>(&glTexImage3D),                                                "glTexImage3D");
		reshade::hooks::queue(reinterpret_cast<reshade::hook::address>(trampoline("wglChoosePixelFormatARB")),                       reinterpret_cast<reshade::hook::address>(&wglChoosePixelFormatARB),                                     "wglChoosePixelFormatARB");
		reshade::hooks::queue(reinterpret_cast<reshade::hook::address>(trampoline("wglCreateContextAttribsARB")),                    reinterpret_cast<reshade::hook::address>(&wglCreateContextAttribsARB),                                  "wglCreateContextAttribsARB");
		reshade::hooks::queue(reinterpret_cast<reshade::hook::address>(trampoline("wglCreatePbufferARB")),                           reinterpret_cast<reshade::hook::address>(&wglCreatePbufferARB),                                         "wglCreatePbufferARB");
		reshade::hooks::queue(reinterpret_cast<reshade::hook::address>(trampoline("wglDestroyPbufferARB")),                          reinterpret_cast<reshade::hook::address>(&wglDestroyPbufferARB),                                        "wglDestroyPbufferARB");
		reshade::hooks::queue(reinterpret_cast<reshade::hook::address>(trampoline("wglGetExtensionsStringARB")),                     reinterpret_cast<reshade::hook::address>(&wglGetExtensionsStringARB),                                   "wglGetExtensionsStringARB");
		reshade::hooks::queue(reinterpret_cast<reshade::hook::address>(trampoline("wglGetPbufferDCARB")),                            reinterpret_cast<reshade::hook::address>(&wglGetPbufferDCARB),                                          "wglGetPbufferDCARB");
		reshade::hooks::queue(reinterpret_cast<reshade::hook::address>(trampoline("wglGetPixelFormatAttribivARB")),                  reinterpret_cast<reshade::hook::address>(&wglGetPixelFormatAttribivARB),                                "wglGetPixelFormatAttribivARB");
		reshade::hooks::queue(reinterpret_cast<reshade::hook::address>(trampoline("wglGetPixelFormatAttribfvARB")),                  reinterpret_cast<reshade::hook::address>(&wglGetPixelFormatAttribfvARB),                                "wglGetPixelFormatAttribfvARB");
		reshade::hooks::queue(reinterpret_cast<reshade::hook::address>(trampoline("wglQueryPbufferARB")),                            reinterpret_cast<reshade::hook::address>(&wglQueryPbufferARB),                                          "wglQueryPbufferARB");
		reshade::hooks::queue(reinterpret_cast<reshade::hook::address>(trampoline("wglReleasePbufferDCARB")),                        reinterpret_cast<reshade::hook::address>(&wglReleasePbufferDCARB),                                      "wglReleasePbufferDCARB");
		reshade::hooks::queue(reinterpret_cast<reshade::hook::address>(trampoline("wglGetSwapIntervalEXT")),                         reinterpret_cast<reshade::hook::address>(&wglGetSwapIntervalEXT),                                       "wglGetSwapIntervalEXT");
		reshade::hooks::queue(reinterpret_cast<reshade::hook::address>(trampoline("wglSwapIntervalEXT")),                            reinterpret_cast<reshade::hook::address>(&wglSwapIntervalEXT),                                          "wglSwapIntervalEXT");

    reshade::hooks::apply_queued ();
	...
	//else if (strcmp(lpszProc, "glDrawArraysIndirect") == 0)
		//reshade::hooks::defer(reinterpret_cast<reshade::hook::address>(address), reinterpret_cast<reshade::hook::address>(&glDrawArraysIndirect));
	//else if (strcmp(lpszProc, "glDrawArraysInstanced") == 0)
		//reshade::hooks::defer(reinterpret_cast<reshade::hook::address>(address), reinterpret_cast<reshade::hook::address>(&glDrawArraysInstanced));
	//else if (strcmp(lpszProc, "glDrawArraysInstancedEXT") == 0)
		//reshade::hooks::defer(reinterpret_cast<reshade::hook::address>(address), reinterpret_cast<reshade::hook::address>(&glDrawArraysInstancedEXT));
	//else if (strcmp(lpszProc, "glDrawArraysInstancedBaseInstance") == 0)
		//reshade::hooks::defer(reinterpret_cast<reshade::hook::address>(address), reinterpret_cast<reshade::hook::address>(&glDrawArraysInstancedBaseInstance));
	...
	//else if (strcmp(lpszProc, "glDrawElementsBaseVertex") == 0)
		//reshade::hooks::defer(reinterpret_cast<reshade::hook::address>(address), reinterpret_cast<reshade::hook::address>(&glDrawElementsBaseVertex));
	//else if (strcmp(lpszProc, "glDrawElementsIndirect") == 0)
		//reshade::hooks::defer(reinterpret_cast<reshade::hook::address>(address), reinterpret_cast<reshade::hook::address>(&glDrawElementsIndirect));
	//else if (strcmp(lpszProc, "glDrawElementsInstanced") == 0)
		//reshade::hooks::defer(reinterpret_cast<reshade::hook::address>(address), reinterpret_cast<reshade::hook::address>(&glDrawElementsInstanced));
	//else if (strcmp(lpszProc, "glDrawElementsInstancedEXT") == 0)
		//reshade::hooks::defer(reinterpret_cast<reshade::hook::address>(address), reinterpret_cast<reshade::hook::address>(&glDrawElementsInstancedEXT));
	//else if (strcmp(lpszProc, "glDrawElementsInstancedBaseVertex") == 0)
		//reshade::hooks::defer(reinterpret_cast<reshade::hook::address>(address), reinterpret_cast<reshade::hook::address>(&glDrawElementsInstancedBaseVertex));
	//else if (strcmp(lpszProc, "glDrawElementsInstancedBaseInstance") == 0)
		//reshade::hooks::defer(reinterpret_cast<reshade::hook::address>(address), reinterpret_cast<reshade::hook::address>(&glDrawElementsInstancedBaseInstance));
	//else if (strcmp(lpszProc, "glDrawElementsInstancedBaseVertexBaseInstance") == 0)
		//reshade::hooks::defer(reinterpret_cast<reshade::hook::address>(address), reinterpret_cast<reshade::hook::address>(&glDrawElementsInstancedBaseVertexBaseInstance));
	//else if (strcmp(lpszProc, "glDrawRangeElements") == 0)
		//reshade::hooks::defer(reinterpret_cast<reshade::hook::address>(address), reinterpret_cast<reshade::hook::address>(&glDrawRangeElements));
	//else if (strcmp(lpszProc, "glDrawRangeElementsBaseVertex") == 0)
		//reshade::hooks::defer(reinterpret_cast<reshade::hook::address>(address), reinterpret_cast<reshade::hook::address>(&glDrawRangeElementsBaseVertex));
	...
	//	reshade::hooks::defer(reinterpret_cast<reshade::hook::address>(address), reinterpret_cast<reshade::hook::address>(&glFramebufferRenderbuffer));
	//else if (strcmp(lpszProc, "glFramebufferRenderbufferEXT") == 0)
	//	reshade::hooks::defer(reinterpret_cast<reshade::hook::address>(address), reinterpret_cast<reshade::hook::address>(&glFramebufferRenderbufferEXT));
	//else if (strcmp(lpszProc, "glFramebufferTexture") == 0)
	//	reshade::hooks::defer(reinterpret_cast<reshade::hook::address>(address), reinterpret_cast<reshade::hook::address>(&glFramebufferTexture));
	//else if (strcmp(lpszProc, "glFramebufferTextureEXT") == 0)
	//	reshade::hooks::defer(reinterpret_cast<reshade::hook::address>(address), reinterpret_cast<reshade::hook::address>(&glFramebufferTextureEXT));
	//else if (strcmp(lpszProc, "glFramebufferTexture1D") == 0)
	//	reshade::hooks::defer(reinterpret_cast<reshade::hook::address>(address), reinterpret_cast<reshade::hook::address>(&glFramebufferTexture1D));
	//else if (strcmp(lpszProc, "glFramebufferTexture1DEXT") == 0)
	//	reshade::hooks::defer(reinterpret_cast<reshade::hook::address>(address), reinterpret_cast<reshade::hook::address>(&glFramebufferTexture1DEXT));
	//else if (strcmp(lpszProc, "glFramebufferTexture2D") == 0)
	//	reshade::hooks::defer(reinterpret_cast<reshade::hook::address>(address), reinterpret_cast<reshade::hook::address>(&glFramebufferTexture2D));
	//else if (strcmp(lpszProc, "glFramebufferTexture2DEXT") == 0)
	//	reshade::hooks::defer(reinterpret_cast<reshade::hook::address>(address), reinterpret_cast<reshade::hook::address>(&glFramebufferTexture2DEXT));
	//else if (strcmp(lpszProc, "glFramebufferTexture3D") == 0)
	//	reshade::hooks::defer(reinterpret_cast<reshade::hook::address>(address), reinterpret_cast<reshade::hook::address>(&glFramebufferTexture3D));
	//else if (strcmp(lpszProc, "glFramebufferTexture3DEXT") == 0)
	//	reshade::hooks::defer(reinterpret_cast<reshade::hook::address>(address), reinterpret_cast<reshade::hook::address>(&glFramebufferTexture3DEXT));
	//else if (strcmp(lpszProc, "glFramebufferTextureLayer") == 0)
	//	reshade::hooks::defer(reinterpret_cast<reshade::hook::address>(address), reinterpret_cast<reshade::hook::address>(&glFramebufferTextureLayer));
	//else if (strcmp(lpszProc, "glFramebufferTextureLayerEXT") == 0)
	//	reshade::hooks::defer(reinterpret_cast<reshade::hook::address>(address), reinterpret_cast<reshade::hook::address>(&glFramebufferTextureLayerEXT));
	...
	//	reshade::hooks::defer(reinterpret_cast<reshade::hook::address>(address), reinterpret_cast<reshade::hook::address>(&glMultiDrawArrays));
	//else if (strcmp(lpszProc, "glMultiDrawArraysIndirect") == 0)
	//	reshade::hooks::defer(reinterpret_cast<reshade::hook::address>(address), reinterpret_cast<reshade::hook::address>(&glMultiDrawArraysIndirect));
	//else if (strcmp(lpszProc, "glMultiDrawElements") == 0)
	//	reshade::hooks::defer(reinterpret_cast<reshade::hook::address>(address), reinterpret_cast<reshade::hook::address>(&glMultiDrawElements));
	//else if (strcmp(lpszProc, "glMultiDrawElementsBaseVertex") == 0)
	//	reshade::hooks::defer(reinterpret_cast<reshade::hook::address>(address), reinterpret_cast<reshade::hook::address>(&glMultiDrawElementsBaseVertex));
	//else if (strcmp(lpszProc, "glMultiDrawElementsIndirect") == 0)
	//	reshade::hooks::defer(reinterpret_cast<reshade::hook::address>(address), reinterpret_cast<reshade::hook::address>(&glMultiDrawElementsIndirect));
	...
	//	reshade::hooks::defer(reinterpret_cast<reshade::hook::address>(address), reinterpret_cast<reshade::hook::address>(&glTexImage3D));
	...
	//	reshade::hooks::defer(reinterpret_cast<reshade::hook::address>(address), reinterpret_cast<reshade::hook::address>(&wglChoosePixelFormatARB));
	//else if (strcmp(lpszProc, "wglCreateContextAttribsARB") == 0)
	//	reshade::hooks::defer(reinterpret_cast<reshade::hook::address>(address), reinterpret_cast<reshade::hook::address>(&wglCreateContextAttribsARB));
	//else if (strcmp(lpszProc, "wglCreatePbufferARB") == 0)
	//	reshade::hooks::defer(reinterpret_cast<reshade::hook::address>(address), reinterpret_cast<reshade::hook::address>(&wglCreatePbufferARB));
	//else if (strcmp(lpszProc, "wglDestroyPbufferARB") == 0)
	//	reshade::hooks::defer(reinterpret_cast<reshade::hook::address>(address), reinterpret_cast<reshade::hook::address>(&wglDestroyPbufferARB));
	//else if (strcmp(lpszProc, "wglGetExtensionsStringARB") == 0)
	//	reshade::hooks::defer(reinterpret_cast<reshade::hook::address>(address), reinterpret_cast<reshade::hook::address>(&wglGetExtensionsStringARB));
	//else if (strcmp(lpszProc, "wglGetPbufferDCARB") == 0)
	//	reshade::hooks::defer(reinterpret_cast<reshade::hook::address>(address), reinterpret_cast<reshade::hook::address>(&wglGetPbufferDCARB));
	//else if (strcmp(lpszProc, "wglGetPixelFormatAttribivARB") == 0)
	//	reshade::hooks::defer(reinterpret_cast<reshade::hook::address>(address), reinterpret_cast<reshade::hook::address>(&wglGetPixelFormatAttribivARB));
	//else if (strcmp(lpszProc, "wglGetPixelFormatAttribfvARB") == 0)
	//	reshade::hooks::defer(reinterpret_cast<reshade::hook::address>(address), reinterpret_cast<reshade::hook::address>(&wglGetPixelFormatAttribfvARB));
	//else if (strcmp(lpszProc, "wglQueryPbufferARB") == 0)
	//	reshade::hooks::defer(reinterpret_cast<reshade::hook::address>(address), reinterpret_cast<reshade::hook::address>(&wglQueryPbufferARB));
	//else if (strcmp(lpszProc, "wglReleasePbufferDCARB") == 0)
	//	reshade::hooks::defer(reinterpret_cast<reshade::hook::address>(address), reinterpret_cast<reshade::hook::address>(&wglReleasePbufferDCARB));
	//else if (strcmp(lpszProc, "wglGetSwapIntervalEXT") == 0)
	//	reshade::hooks::defer(reinterpret_cast<reshade::hook::address>(address), reinterpret_cast<reshade::hook::address>(&wglGetSwapIntervalEXT));
	//else if (strcmp(lpszProc, "wglSwapIntervalEXT") == 0)
	//	reshade::hooks::defer(reinterpret_cast<reshade::hook::address>(address), reinterpret_cast<reshade::hook::address>(&wglSwapIntervalEXT));
